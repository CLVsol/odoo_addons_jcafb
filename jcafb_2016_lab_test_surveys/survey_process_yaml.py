        ...
        for key4 in sorted(doc[key1][key2][key3].keys()):
            try:
                ...
                if _model_ == 'survey.label.col' or _model_ == 'survey.label.row':
                    label_sequence += 10
                    survey_label_matrix(doc, yaml_out_file, xml_file, txt_file, key1, key2, key3, key4, _type_, _id_, label_sequence)
            except Exception, e:
                pass
...
if __name__ == '__main__':
    ...
    # yaml_filename = 'LCP16/lab_jcafb_LCP16.xml'
    # yaml_out_filename = 'LCP16/lab_jcafb_LCP16_out.yaml'
    # xml_filename = 'LCP16/lab_jcafb_LCP16.xml'
    # txt_filename = 'LCP16/lab_jcafb_LCP16.txt'
    ...
    # yaml_filename = 'LUI16/lab_jcafb_LUI16.yaml'
    # yaml_out_filename = 'LUI16/lab_jcafb_LUI16_out.yaml'
    # xml_filename = 'LUI16/lab_jcafb_LUI16.xml'
    # txt_filename = 'LUI16/lab_jcafb_LUI16.txt'
    # print '--> Executing survey_process_yaml(%s, %s, %s) ...' % (yaml_filename, xml_filename, txt_filename)
    # survey_process_yaml(yaml_filename, yaml_out_filename, xml_filename, txt_filename)
